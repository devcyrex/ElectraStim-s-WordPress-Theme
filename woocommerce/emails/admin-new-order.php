...
<p><?php printf( __( 'We have received an order. The order is as follows:', 'woocommerce' ), $order->get_formatted_billing_full_name() ); ?></p>
		...
		<?php
			if ( $totals = $order->get_order_item_totals() ) {
				...
				foreach ( $totals as $total ) {
					...
					$shipping_details = $order->get_shipping_method();
