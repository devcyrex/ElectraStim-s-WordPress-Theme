		...
		<div class="bordered-block">
			...
			<form method="post" class="login">
				...
				<p class="form-row form-row-wide form-group">
					<input type="text" class="input-text form-control" name="username" id="username" value="<?php if ( ! empty( $_POST['username'] ) ) echo esc_attr( $_POST['username'] ); ?>" placeholder="<?php _e( 'Email address', 'woocommerce' ); ?>" />
				</p>
				<p class="form-row form-row-wide form-group">
...
<?php if ($has_registration_form) : ?>
	...
	<div class="col-sm-6 form-register-env">
		...
		<div class="bordered-block">
			...
			<form method="post" class="register" onsubmit="loginPage()">
				...
				<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
					...
					<p class="form-row form-row-wide form-group">
						<input type="password" class="input-text form-control" id="reenter_password" placeholder="<?php _e( 'Re-enter Password', 'woocommerce' ); ?> *" />
					</p>
