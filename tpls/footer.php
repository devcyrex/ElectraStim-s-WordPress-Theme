...
<footer class="site-footer<?php echo $footer_style ? " {$footer_style}" : ''; echo ! $footer_widgets ? ' no-footer-widgets' : ''; ?>">
	...
	<div class="container">
		...
		<div class="row visible-xs max_width">
			<div class="col-lg-12 no_padding max_width">
				<a href="#" class="expand-footer resize_footer_to_mobile"></a>
			</div>
		</div>
		...
		<div class="footer-bottom">
			...
			<div class="row max_width" style="max_width: 100%;">
