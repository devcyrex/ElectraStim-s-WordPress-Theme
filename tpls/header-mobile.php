...
<header class="mobile-menu<?php echo $header_sticky_menu_mobile ? ' sticky-mobile' : ''; ?>">
	...
	<section class="mobile-logo">
		...
		<div class="mobile-toggles">
			<a class="toggle-menu" href="#">
				<?php echo lab_get_svg_child('images/toggle-menu.svg'); ?>
	...
	<section class="cart-info">
		<a class="cart-counter<?php echo $cart_items_count ? ' has-notifications' : ''; echo $shop_cart_counter_ajax ? ' cart-counter-ajax' : ''; ?>" href="<?php echo WC()->cart->get_cart_url(); ?>">
